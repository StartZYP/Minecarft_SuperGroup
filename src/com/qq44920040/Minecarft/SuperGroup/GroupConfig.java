...
public class GroupConfig {
    ...
    public static String SuperGroupListTitle;
    public static String[] SGlistItem;
    public static String PageUpButtonDisPlay ;
    public static String PageDownButtonDisPlay;
